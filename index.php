...
to say hi! You can contact me at kieran@kieranhorgan.ie or through the contact form at
the end of the page.
...
-->     <nav> <!-- Links call a javascript ofunction instead of a normal hyperlink -->
		...
		<section id="social">
			...
			<a href="mailto:kieran@kieranhorgan.ie">
			...
			<section id="slidesContainer">
				...
				<section id="slide3" class="slide">
					<div class="container">
						...
						<a href="https://circleswwd.kieranhorgan.ie" class="button">View Site</a>
					</div>
				...
				<section id="slide2" class="slide">
					<div class="container">
						...
						<span class="line"></span>
						<a href="https://utictactoe.kieranhorgan.ie" class="button">View Site</a>
					</div>
				...
				<section id="slide1" class="slide">
					...
					<div class="container">
						...
						<span class="line"></span>
						<a href="https://coderdojomallow.kieranhorgan.ie" class="button">View Site</a>
					</div>
...
--> 	<section id="achievements">
			<div class="container">
				...
				<ul>
					...
					<li>
						Mentor at <a href="https://coderdojomallow.utictactoe.ie">CoderDojo Mallow</a> for about 4 years, teaching HTML, CSS, JavaScript and Python to young people aged from 7 to 17 
					</li>
				</ul>
...
-->     <section id="contact">
			<div class="container">
				...
				<p>Email - <a href="mailto:kieran@kieranhorgan.ie">kieran@kieranhorgan.ie</a></p>
...
if (isset($_POST['submit'])) {
	...
	// Success
	} else if (mail('kieran@kieranhorgan.ie', $subject, $body, $headers)) { 
